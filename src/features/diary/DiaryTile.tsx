...
import { setCanEdit, setActiveDiary, setCurrentlyEditing } from '../entry/editorSlice';
...
const DiaryTile: FC<Props> = (props) => {
    ...
    const totalEntries = props.diary.entrysIds?.length;
    ...
    return (
        <div className="diary-tile">
            <h2 className="title" title="Click to edit" onClick={() => setIsEditing(true)} style={{cursor : 'pointer'}} >
                {
                    isEditing ? (
                        <input 
                            type="text" 
